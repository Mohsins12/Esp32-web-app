const SUPABASE_URL = "[https://hvxyydtubqvbtmheluec.supabase.co](https://hvxyydtubqvbtmheluec.supabase.co)";
...
const tableName = "Esp_data_log"; // No extra quotes!
...
if (data.length > 0) {
  ...
  // Show ON/OFF based on deflection threshold
